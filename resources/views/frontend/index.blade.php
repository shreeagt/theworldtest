	...
	<section id="">
		...
		<main class="latest_video">
			<div class="container">
				<div class="row justify-content-md-center">
					<div class="col-lg-12 text-left">
						<h3 class="white mb-30"> Latest Video  </h3>   
					</div>
					<div class="col-lg-12">
						<div class="owl-carousel" id="latest_video">
							<div class="item">
								<div class="ap-slide-content relative">
									<div class="ap-img-box relative">
		...
		<main class="latest_news">
			<div class="container">
				<div class="row justify-content-md-center">
					<div class="col-lg-12 text-left">
						<h3 class="mb-30"> Lastes News  </h3>   
					</div>
					<div class="col-lg-12">
						<div class="owl-carousel" id="latest_news">
							<div class="item">
								<div class="ap-slide-content relative">
									<div class="ap-img-box relative">
										<img src="https://bcciplayerimages.s3.ap-south-1.amazonaws.com/bcci/articles/1642825007_IPL-2022.jpg" class="img-fluid" />
		...
		<main class="latest_video" style="background:none;">
			<div class="container">
				<div class="row justify-content-md-center">
					<div class="col-lg-12 text-left">
						<h3 class="mb-30"> Top Highlights  </h3>   
					</div>
					<div class="col-lg-12">
