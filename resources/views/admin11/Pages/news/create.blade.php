...
<form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <input hidden value="{{$videos_details->id}}" name="news_id"/>
    @endif
    <div class="form-group">
      <label for="exampleInputEmail1">News Title</label>
      <input type="text" class="form-control" name="news_title" required value="{{ isset($videos_details)?$videos_details->video_title:'' }}" aria-describedby="emailHelp" placeholder="Enter News Title">

    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">News URL</label>
      <input type="text" class="form-control" name="news_url" required value="{{isset($videos_details)?$videos_details->video_url:''}}" {{isset($videos_details)?'readonly':''}}  placeholder="Enter News URL">
    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">Select News Category</label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">News Tag</label>
        <input type="text" class="form-control" id="news_tag" name="news_tag"  placeholder="Enter News Tag">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">News Description</label>
        <input type="text" class="form-control" name="news_description"  placeholder="Enter News Description">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">News Keyword</label>
        <input type="text" class="form-control" id="news_keyword" name="news_keyword" placeholder="Enter News Keywords">
      </div>

      <div class="form-group">
        <label for="editor">News Body</label>
        <textarea class="editor" name="editor" id="editor"></textarea>
      </div>

      <div class="form-group">
        <label for="editor">News Thumbnail</label>
        <input type="file" name="news_thumbnail" class="form-control"/>
      </div>
      <div class="form-group">
        <label for="editor">News Banner Type</label>
        <select name="news_banner_type" class="form-control">
          <option value="Image">Image</option>
          <option value="Video">Video</option>
        </select>
      </div>
      <div class="form-group">
        <label for="editor">News Banner</label>
        <input type="file" name="news_banner" class="form-control"/>
      </div>
      <div class="form-group">
        <label for="editor">News Status</label>
