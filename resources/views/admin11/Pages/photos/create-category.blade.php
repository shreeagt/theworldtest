...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-sm-8">
      ...
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('admin-photos-category.create') }}">Add Photo Category</a></li>
      </ol>
  </div>
  <div class="col-sm-4">
...
<form action="{{route('admin-photos-category.store')}}" method="POST" enctype="multipart/form-data">
  @csrf
  @if (isset($category_details))
  
  <input hidden value="{{$category_details->id}}" name="photo_id"/>
  @endif
    <div class="form-group">
      <label for="exampleInputEmail1">Category Name</label>
      <input type="text" class="form-control" name="name" required  placeholder="Enter Category Name" value="{{isset($category_details)?$category_details->blog_title:''}}">
    ...
    {{-- <div class="form-group">
        ...
        <input type="text" class="form-control" id="blog_tag" name="blog_tag"   placeholder="Enter Blog Tag" value="{{isset($category_details)?$category_details->blog_tag:''}}">
      </div> --}}
      <div class="form-group">
        <label for="exampleInputPassword1">Category Description</label>
        <input type="text" class="form-control" name="category_description" required  placeholder="Enter Category Description" value="{{isset($category_details)?$category_details->blog_description:''}}">
      </div>
      {{-- <div class="form-group">
        <label for="exampleInputPassword1">Blog Keyword</label>
        <input type="text" class="form-control" id="blog_keyword" name="blog_keyword"  placeholder="Enter Blog Keywords" value="{{isset($category_details)?$category_details->blog_keyword:''}}">
      </div> --}}

      <div class="form-group">
        <label for="editor">Category Details</label>
        <textarea class="editor" name="editor" id="editor">{!! isset($category_details)?$category_details->blog_body:'' !!}</textarea>
      </div>

      <div class="form-group">
        <label for="category_thumbnail">Category Thumbnail</label>
        <input type="file" name="category_thumbnail" class="form-control" {{isset($category_details)?'':'required'}}/>
        <img src="{{isset($category_details)?$category_details->blog_thumbnail:''}}" style="height: 200px;" alt=""/>
      </div>
   
      <div class="form-group">
        <label for="category_banner">Category Banner</label>
        <input type="file" name="category_banner" class="form-control" {{isset($category_details)?'':'required'}}/>
        <img src="{{isset($category_details)?$category_details->blog_banner:''}}" style="height: 200px;" alt=""/>
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">SEO Title</label>
        <input type="text" class="form-control"  name="seo_title"   placeholder="Enter SEO Title" value="{{isset($category_details)?$category_details->blog_tag:''}}">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">SEO Tag</label>
        <input type="text" class="form-control" id="seo_tag" name="seo_tag"   placeholder="Enter SEO Tags" value="{{isset($category_details)?$category_details->blog_tag:''}}">
      </div>

      <div class="form-group">
        <label for="exampleInputPassword1">SEO Keyword</label>
        <input type="text" class="form-control" id="seo_keyword" name="seo_keyword"  placeholder="Enter SEO Keywords" value="{{isset($category_details)?$category_details->blog_keyword:''}}">
      </div>
      <div class="form-group">
