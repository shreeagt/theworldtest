  ...
  @endif
    ...
    {{-- <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="category_description" required  placeholder="Enter Description" value="{{isset($blog_details)?$blog_details->blog_description:''}}">
      </div>
      {{-- <div class="form-group">
