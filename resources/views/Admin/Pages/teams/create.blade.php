...
<form action="{{ route('teams.store') }}" method="POST" enctype="multipart/form-data">
    ...
    @if (isset($teams_details))
  
    <input hidden value="{{$teams_details->id}}" name="team_id"/>
    @endif
    <div class="form-group">
      <label for="exampleInputEmail1">Team Name</label>
      <input type="text" class="form-control" name="team_name" required value="{{ isset($teams_details)?$teams_details->team_name:'' }}" aria-describedby="emailHelp" placeholder="Enter Team Name">

    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">Team Key</label>
      <input type="text" class="form-control" name="team_key" required value="{{isset($teams_details)?$teams_details->team_key:''}}" {{isset($teams_details)?'readonly':''}}  placeholder="Enter Team Key">
    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">Team Tags</label>
      <input type="text" class="form-control" id="team_tag" name="team_tag" required value="{{isset($teams_details)?$teams_details->team_tag:''}}" {{isset($teams_details)?'readonly':''}}  placeholder="Enter Team Tag">
    </div>
    
    <div class="form-group">
        <label for="exampleInputPassword1">Team Keywords</label>
        <input type="text" class="form-control" id="team_keywords" name="team_keywords" value="{{isset($teams_details)?$teams_details->team_keywords:''}}"  placeholder="Enter Team Keywords">
    </div>

    <div class="form-group">
        <label for="editor">Team Banner</label>
        <input type="file" name="team_banner" {{isset($teams_details)?'':'required'}} class="form-control"/>
        <img src="{{isset($teams_details)?$teams_details->team_banner:''}}" style="height: 200px;" alt=""/>
    </div>
    <div class="form-group">
        <label for="editor">Team Logo</label>
        <input type="file" name="team_logo" class="form-control" {{isset($teams_details)?'':'required'}}/>
        <img src="{{isset($teams_details)?$teams_details->team_logo:''}}" style="height: 200px;" alt=""/>
    </div>
