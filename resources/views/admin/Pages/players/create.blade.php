...
<form action="{{ route('players.store') }}" method="POST" enctype="multipart/form-data">
    ...
    @if (isset($player_details))
  
    <input hidden value="{{$player_details->id}}" name="player_id"/>
    @endif
    <div class="form-group">
      <label for="exampleInputEmail1">Player Name</label>
      <input type="text" class="form-control" name="player_name" required value="{{ isset($player_details)?$player_details->player_name:'' }}" aria-describedby="emailHelp" placeholder="Enter Player Name">

    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">Player Key</label>
      <input type="text" class="form-control" name="player_key" required value="{{isset($player_details)?$player_details->player_key:''}}" {{isset($player_details)?'readonly':''}}  placeholder="Enter Player Key">
    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">Player Tags</label>
      <input type="text" class="form-control" id="player_tag" name="player_tag" required value="{{isset($player_details)?$player_details->player_tag:''}}" {{isset($player_details)?'readonly':''}}  placeholder="Enter Player Tag">
    </div>
    
    <div class="form-group">
        <label for="exampleInputPassword1">Player Keywords</label>
        <input type="text" class="form-control" id="player_keywords" name="player_keywords" value="{{isset($player_details)?$player_details->player_keywords:''}}"  placeholder="Enter Player Keywords">
    </div>

    <div class="form-group">
        <label for="editor">Player Image</label>
        <input type="file" name="player_image" class="form-control" {{isset($player_details)?'':'required'}}/>
        <img src="{{isset($player_details)?$player_details->player_image:''}}" style="height: 200px;" alt=""/>
    </div>

    <div class="form-group">
        <label for="player_team">Select Team of Player</label>
        <select name="player_team" class="form-control" required>
        {{-- <option value=""></option> --}}
    ...
    <div class="form-group">
    <label for="player_speciality">Player Speciality</label>
    <select name="player_speciality" class="form-control" required>
        <option {{isset($player_details)?$player_details->player_speciality=='Batsman'?'selected':'':''}} value="Batsman">Batsman</option>
        <option {{isset($player_details)?$player_details->player_speciality=='Bowler'?'selected':'':''}} value="Bowler">Bowler</option>
        <option {{isset($player_details)?$player_details->player_speciality=='Wicket Keeper'?'selected':'':''}} value="Wicket Keeper">Wicket Keeper</option>
        <option {{isset($player_details)?$player_details->player_speciality=='All Rounder'?'selected':'':''}} value="All Rounder">All Rounder</option>
    </select>
    </div>

    <div class="form-group">
    <label for="player_position">Player Position</label>
    <select name="player_position" class="form-control" required>
        <option {{isset($player_details)?$player_details->player_position=='Captain'?'selected':'':''}} value="Captain">Captain</option>
        <option {{isset($player_details)?$player_details->player_position=='Vice Captain'?'selected':'':''}} value="Vice Captain">Vice Captain</option>
        <option {{isset($player_details)?$player_details->player_position=='Normal Player'?'selected':'':''}} value="Normal Player">Bowler</option>
    </select>
    </div>
