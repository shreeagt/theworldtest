...
<form action="{{route('admin-videos-category.store')}}" method="POST" enctype="multipart/form-data">
  @csrf
  ...
  @endif
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="name" required  placeholder="Enter Category Name" value="{{isset($blog_details)?$blog_details->blog_title:''}}">
    ...
    {{-- <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="category_description" required  placeholder="Enter Blog Description" value="{{isset($blog_details)?$blog_details->blog_description:''}}">
      </div>
      {{-- <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="file" name="category_thumbnail" class="form-control" {{isset($blog_details)?'':'required'}}/>
      ...
      <div class="form-group">
        ...
        <input type="file" name="category_banner" class="form-control" {{isset($blog_details)?'':'required'}}/>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control"  name="seo_title"   placeholder="Enter SEO Title" value="{{isset($blog_details)?$blog_details->blog_tag:''}}">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">SEO Tag</label>
        <input type="text" class="form-control" id="seo_tag" name="seo_tag"   placeholder="Enter SEO Tags" value="{{isset($blog_details)?$blog_details->blog_tag:''}}">
      </div>

      <div class="form-group">
        <label for="exampleInputPassword1">SEO Keyword</label>
        <input type="text" class="form-control" id="seo_keyword" name="seo_keyword"  placeholder="Enter SEO Keywords" value="{{isset($blog_details)?$blog_details->blog_keyword:''}}">
      </div>
      <div class="form-group">
