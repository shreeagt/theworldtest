...
<form action="{{ route('venues.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <input hidden value="{{$venue_details->id}}" name="venue_id"/>
    @endif
    <div class="form-group">
      <label for="exampleInputEmail1">Venue Name</label>
      <input type="text" class="form-control" name="venue_name" required value="{{ isset($venue_details)?$venue_details->venue_name:'' }}" aria-describedby="emailHelp" placeholder="Enter Venue Name">

    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">Venue Key</label>
      <input type="text" class="form-control" name="venue_key" required value="{{isset($venue_details)?$venue_details->venue_key:''}}" {{isset($venue_details)?'readonly':''}}  placeholder="Enter Venue Key">
    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">Venue Tags</label>
      <input type="text" class="form-control" id="venue_tag" name="venue_tag" required value="{{isset($venue_details)?$venue_details->venue_tag:''}}" {{isset($venue_details)?'readonly':''}}  placeholder="Enter Venue Tag">
    </div>
    
    <div class="form-group">
        <label for="exampleInputPassword1">Venue Keywords</label>
        <input type="text" class="form-control" id="venue_keywords" name="venue_keywords" value="{{isset($venue_details)?$venue_details->venue_keywords:''}}"  placeholder="Enter Venue Keywords">
    </div>

    <div class="form-group">
        <label for="editor">Venue Tumbnail</label>
        <input type="file" name="venue_thumbnail" class="form-control" {{isset($venue_details)?'':'required'}}/>
        <img src="{{isset($venue_details)?$venue_details->venue_thumbnail:''}}" style="height: 200px;" alt=""/>
    </div>
