...
$config['licenseName'] = 'skyelink.ai';
$config['licenseKey']  = '*6?8-*1**-L**S-*M**-*9**-P*U*-5**E';
...
//     'name'         => 'default',
//     'adapter'      => 's3',
//     'bucket'       => config('constant.ckfinder_aws_bucket'),
//     'region'       => config('constant.ckfinder_aws_region'),
//     'key'          => config('constant.ckfinder_aws_access_key'),
//     'secret'       => config('constant.ckfinder_aws_secret_access_key'),
//     'visibility'   => 'public',
//     'baseUrl'      => config('constant.ckfinder_aws_url'),
//     'root'         => config('constant.ckfinder_root'),
// );
...
$config['backends']['default'] = array(
    ...
    'bucket'       => 'skyelink',
    'region'       => 'ap-south-1',
    'key'          => 'AKIAIQH46HWZE3664V2Q',
    'secret'       => '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',
    'visibility'   => 'private',
    'baseUrl'      => 'https://skyelink.s3.ap-south-1.amazonaws.com/ckfinder/',
    'root'         => 'ckfinder',
);
